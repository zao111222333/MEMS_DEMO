...
def plot(t,name):
    ...
    amplitude = 0.05
    amplitude2= 0.03
    y = 0.4 + amplitude2*math.sin(2*math.pi*t/T)
    print(y)
    ttt = np.arange(t, t+T, 0.02)
    y1 = amplitude2*np.sin(2*math.pi*ttt/T)
    ...
    range1 = plt.Line2D([x0+y0+y_ruler-2*(0.4+amplitude2+0.025),x0+y0+y_ruler-2*(0.4-amplitude2+0.025)], [y_ruler, y_ruler], lw=3,color='g')
    plt.gca().add_line(ruler)
    plt.gca().add_line(range0)
    plt.gca().add_line(range1)



    plt.plot((y_ruler-yt+xt),(y_ruler), 'o', color='g',mew=5)
    ...
    #plt.gca().add_line(ruler)
    #
    plt.yticks([-amplitude,-amplitude2,amplitude,amplitude2])
    ...
    plt.scatter(ttt,y1,color='g')
    plt.plot((t),(y1[0]), 'o', color='g',mew=10)
    plt.text(t-0.44, y1[0]-amplitude*0.05, "%.3f" % y1[0],size=20,color='g')
    ...
    top2 = plt.Line2D([t,t+T], [amplitude2, amplitude2], lw=1,color='g',linestyle="dotted")
    bot2 = plt.Line2D([t,t+T], [-amplitude2, -amplitude2], lw=1,color='g',linestyle="dotted")
    plt.gca().add_line(top2)
    plt.gca().add_line(bot2)
    plt.rcParams['savefig.dpi'] = 100
    plt.savefig('./img2/test'+"%05d" % i+'.png')
